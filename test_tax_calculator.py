...
class TestTaxCalculator(unittest.TestCase):
    ...
    def test_tax_on_interest(self):
        ...
        expect_tax = 0.15*(1500000 + 460000 - 20000)  # exclude first 20,000 Bt interest
        self.assertEqual(expect_tax, self.getTax())
        # test a HUGE amount of interest
        self.addIncome(INTEREST, "Govt Bond", 10000000, 0)
        expect_tax = 0.15*(10000000 + 1500000 + 460000 - 20000)  # exclude first 20,000 Bt
        self.assertEqual(expect_tax, self.getTax())
    ...
    def test_tax_on_dividends(self):
        ...
        self.addIncome(DIVIDEND, "payer4", 300000, 0)  # total income now 700,000
        expect_tax = 48500
        self.assertEqual(expect_tax, self.getTax())
    ...
    def test_ordinary_income_tax(self):
        ...
        income_and_tax = [(150000, 0),       (300000, 7500), 
                          (500000, 27500),   (750000, 65000), 
                          (1000000, 115000), (2000000, 365000), 
                          (4000000, 965000)]
        ...
        for (income, expected_tax) in income_and_tax:
            ...
            self.assertEqual(expected_tax, self.getTax(),
    ...
    def test_ordinary_income_and_deductable_interest(self):
        ...
        for interest in (10000, 20000):
            for (ordinary_income, tax) in income_and_tax:
                ...
                self.assertEqual(tax, self.getTax(), 
    ...
    def test_tax_withholding(self):
        ...
        more_income = 50000   # taxed at a 10% marginal rate (after 60,000 deduction)
    ...
    def getTax(self):
        ...
        """
        return self.tc.compute_tax()

    def addIncome(self, income_type, description, amount, tax_withheld):
        """Utility method to simplify refactoring of add_income().
           Apply your Parameter Object here (only).
        """
        self.tc.add_income(Income(income_type, description, amount, tax_withheld))
